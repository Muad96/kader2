...
from erpnext.hr.doctype.payroll_period import get_payroll_period
...
class FullSalary(TransactionBase):
	def __init__(self, *args, **kwargs):
		super(FullSalary, self).__init__(*args, **kwargs)
	...
	#KADER
	#Attandance Based on Leave (https://github.com/frappe/erpnext/pull/15823/commits/8ad06c8a4abe47c25e41bbf879be1cdf42bd8d86)
